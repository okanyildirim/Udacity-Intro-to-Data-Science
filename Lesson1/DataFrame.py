...
if True:
    myData={"Name":["Okan","Abdullah","Burak","Ahmet","Hilal","Yağmur"],
            "School":["ITU","Hacettepe","19Mayıs","THK","Ankara","Ankara"],
            "Salary":[3500,2500,3000,4000,2700,2000],
            "Length":[1.72,1.77,1.78,1.71,1.60,1.58],
            "Occupation":['Computer Engineer','Referee','Lawyer','Engineer','Judge','Lecturer']}
